...
class CartUpdateTest extends TestCase
{
    ...
    public function test_it_fails_product_cant_be_found()
    {
    ...
    public function test_it_requires_a_quantity_of_a_one_or_more()
    {
        $user = factory(User::class)->create();
    ...
    public function test_it_update_the_quantity_of_product()
    {
        $user = factory(User::class)->create();
